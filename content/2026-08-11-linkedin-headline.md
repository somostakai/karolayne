...
O currículo responde: **"o que essa pessoa já fez?"** Ele é lido por alguém que já decidiu te avaliar. É um documento de comprovação, e o leitor está com a intenção de conferir.

O LinkedIn responde: **"por que eu deveria falar com essa pessoa?"** Ele é lido por alguém que ainda não decidiu nada, que chegou ali por acaso, que está com pressa e tem outras vinte abas abertas.

Currículo é para quem já quer te contratar. LinkedIn é para quem ainda não sabe que precisa de você.

Quando você escreve um no lugar do outro, o resultado é um perfil tecnicamente impecável e completamente mudo.
...
Isso não diz nada que a foto e a experiência já não digam. Você gastou o espaço mais nobre do seu perfil repetindo informação.
...
O denominador comum dos três: nenhum deles diz **para quem** você é útil e **em quê**.

## Uma estrutura que funciona

Não existe fórmula mágica, mas existe uma estrutura que resolve o problema na maior parte dos casos:

**O que você faz + para quem + qual resultado disso**
...
> Analista de Marketing | Ajudo e-commerces a transformar tráfego pago em venda recorrente

O segundo tem o mesmo cargo. Mas agora tem um público (e-commerces), um problema (tráfego que não vira venda) e um resultado (venda recorrente). Quem lê sabe na hora se aquilo tem a ver com o problema dele.

Mais alguns exemplos:

- **RH:** ~~Analista de RH~~ → *Analista de RH | Estruturo processos seletivos que reduzem turnover em empresas em crescimento*
- **Financeiro:** ~~Controller~~ → *Controller | Organizo a casa financeira de PMEs que cresceram rápido demais para a própria contabilidade*
...
**"Mas eu faço muita coisa."** Escolha uma. O headline não é um inventário, é uma porta de entrada. As outras coisas continuam existindo no perfil inteiro, logo abaixo. Você não está apagando nada, está decidindo o que fala primeiro.
...
Responda estas três perguntas em uma frase curta cada, sem se preocupar com bonito:

1. Que tipo de problema chega até você no trabalho?
2. Quem é a pessoa ou o time que chega com esse problema?
3. Como a situação fica depois que você resolve?
